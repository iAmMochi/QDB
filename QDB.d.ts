...
declare module 'QDB' {
    ...
    export class DataSchema {
        constructor(Id: string, Model: Object, Serializer?: Function) {
         ...
         * @param Target The main entry to compare against and to merge changes into.
         * @returns {Object} A merged data object based on this Schema's Model.
         */
        public Instance(Target: Object = {}): Function {
    ...
    export abstract class PartialConnection {
        /**
    ...
    export class Connection extends PartialConnection {
        /**
         ...
         */
        constructor(PathURL: string, RawOptions: Object = {}, _Pool = undefined) {
